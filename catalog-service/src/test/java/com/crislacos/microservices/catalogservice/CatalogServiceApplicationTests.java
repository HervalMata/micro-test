...
class CatalogServiceApplicationTests {
	...
	void whenPutRequestThenBookUpdated() {
		...
		var bookToUpdate = new Book(createdBook.id(), createdBook.isbn(), createdBook.title(), createdBook.author(),
				createdBook.price(), createdBook.publisher(), createdBook.createdDate(), createdBook.lastModifiedDate(),
				createdBook.version());
	...
	void whenDeleteRequestThenBookDeleted() {
		...
		webTestClient
				...
				.expectBody(String.class).value(errorMessage ->
					assertThat(errorMessage).isEqualTo("O livro com ISBN " + bookIsbn + " não foi encontrado.")
				);
	}
